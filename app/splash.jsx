...
export default function Splash() {
  ...
  useEffect(() => {
    ...
    Animated.sequence([
      ...
      Animated.timing(magicAnim, { toValue: 2, duration: 2000, useNativeDriver: false }),
    ]).start();
        ...
        <View style={styles.center}>
          ...
          <Animated.View style={{ opacity: textOpacity, transform: [{ translateY: textTranslateY }], alignItems: 'center' }}>
            ...
            <Text style={styles.subtitle}>
              აღმოაჩინე შენი სხეულის ჰარმონია
            </Text>
          </Animated.View>
        </View>
...
const styles = StyleSheet.create({
  ...
  magicStarWrapper: {
    position: 'absolute',
    // ცენტრში რომ მოექცეს ხაზთან მიმართებაში
    transform: [{ translateX: -12 }, { translateY: -17 }],
  },
  pinkStar: {
    color: '#ff4d88',
    fontSize: 28,
    textShadowColor: "rgba(255, 77, 136, 0.8)",
