...
**"მინდა დაორსულება" — ფაზა 2: Dashboard + Stats (2026-07-11)**: fertility ანალიტიკა `statistics.js` tab-ში (ცალკე ეკრანი არა — pregnancy-ის pattern: `pregnancyMode → fertilityMode → regular`).
