...
**"მინდა დაორსულება" — ფაზა 1: Core Tracking (2026-07-11)**: fertility რეჟიმის საფუძველი. დიზაინი: ორსულობის რეჟიმის ანალოგიურად, `fertilityMode` flag ცვლის tab-ებს (ჯერ calendar + home strip; სხვა tab-ები ფაზა 2+).
