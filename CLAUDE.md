...
**Shared subscription + analytics context (2026-07-11)**: "მინდა დაორსულება" (fertility) და ორსულობის რეჟიმი ერთ `pregnancy` RevenueCat entitlement-ს იზიარებენ — **ერთი $2.99 გამოწერა ორივეს ხსნის** (დიზაინი A, user-ის გადაწყვეტილება). ცალკე პროდუქტი RevenueCat-ში **არ** დაემატა. დაემატა მხოლოდ analytics მარკერი:
