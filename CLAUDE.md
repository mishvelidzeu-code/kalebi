...
**ბანერების ვიზუალის განახლება (2026-07-11)**: (ა) ორივე ბანერში სურათის კონტეინერი გაიზარდა — `pregnancyBannerImageWrap` 78×98 → **104×124**, `pregnancyBannerGradient` minHeight 132 → **152**. (ბ) "მინდა დაორსულება" ბანერს საკუთარი პალიტრა მიეცა (ორსულობის pink/peach-ისგან განსხვავებით **მწვანე-ლურჯი**): `theme.fertilityBannerGradient` (light: mint→aqua→ცისფერი; dark: მუქი მწვანე-ლურჯი), styles `fertilityBannerShell` (მწვანე border/shadow), `fertilityBannerGlowGreen/Blue`, `fertilityBannerEyebrowText` (#0E9F6E), `fertilityBannerDot` (#60A5FA), leaf icon #0E9F6E. Layout styles კვლავ გადაზიარებულია pregnancyBanner*-დან.
