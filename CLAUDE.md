...
**🔓 fertility რეჟიმი გაიხსნა user-ებისთვის (2026-07-11)**: `TEMP_FERTILITY_COMING_SOON` → **`false`** (flag დარჩა როგორც **kill switch** — `true`-ზე დაბრუნება მყისვე ბლოკავს შესვლასაც და გადახდასაც; იხ. `constants/tempFlags.js`).
